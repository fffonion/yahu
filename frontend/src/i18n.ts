const translations: Record<string, Record<string, string>> = {
  ...
  'chat.hideCronSessions': { en: 'Hide cron, CLI, alp-worker, turtle-soup, and turtle-bench conversations', 'zh-CN': '隐藏定时任务、CLI、alp-worker、turtle-soup 和 turtle-bench 对话', 'zh-TW': '隱藏定時任務、CLI、alp-worker、turtle-soup 和 turtle-bench 對話', ja: 'cron・CLI・alp-worker・turtle-soup・turtle-bench会話を非表示' },
  'chat.showCronSessions': { en: 'Show cron, CLI, alp-worker, turtle-soup, and turtle-bench conversations', 'zh-CN': '显示定时任务、CLI、alp-worker、turtle-soup 和 turtle-bench 对话', 'zh-TW': '顯示定時任務、CLI、alp-worker、turtle-soup 和 turtle-bench 對話', ja: 'cron・CLI・alp-worker・turtle-soup・turtle-bench会話を表示' },
  ...
  'chat.skillPickerPlaceholder': { en: 'Search skills…', 'zh-CN': '搜索技能…', 'zh-TW': '搜尋技能…', ja: 'スキル検索…' },
  'chat.skillPickerHeading.search': { en: 'Search skills', 'zh-CN': '搜索技能', 'zh-TW': '搜尋技能', ja: 'スキル検索' },
  'chat.skillPickerHeading.recent': { en: 'Recent skills', 'zh-CN': '最近使用的技能', 'zh-TW': '最近使用的技能', ja: '最近使ったスキル' },
  'chat.skillPickerEmpty': { en: 'No matching skills', 'zh-CN': '没有匹配的技能', 'zh-TW': '沒有符合的技能', ja: '一致するスキルがありません' },
  'chat.skillPickerAria': { en: 'Skills and files', 'zh-CN': '技能和文件', 'zh-TW': '技能和檔案', ja: 'スキルとファイル' },
  'chat.skillChipAria': { en: 'Skill {0}', 'zh-CN': '技能 {0}', 'zh-TW': '技能 {0}', ja: 'スキル {0}' },
  ...
  'chat.deleteConfirm': { en: 'Delete this session? This cannot be undone.', 'zh-CN': '确定删除这个会话？此操作不可撤销。', 'zh-TW': '確定刪除這個會話？此操作不可撤銷。', ja: 'このセッションを削除しますか？元に戻せません。' },
...
'skills.enabled': { en: 'Enabled skill', 'zh-CN': '已启用技能', 'zh-TW': '已啟用技能', ja: 'スキルを有効化' },
  ...
  'settings.mobileNavHint': { en: 'Choose up to 7 items. Settings stays at the top.', 'zh-CN': '最多选择 7 项；设置页始终位于顶部。', 'zh-TW': '最多選擇 7 項；設定頁固定在頂部。', ja: '最大7項目まで選択できます。設定は上部に固定されます。' },
...
'settings.restartingUpdate': { en: 'Restarting…', 'zh-CN': '正在重启…', 'zh-TW': '正在重啟…', ja: '再起動中…' },
  ...
  'usage.calls': { en: 'Calls', 'zh-CN': '调用次数', 'zh-TW': '呼叫次數', ja: '呼び出し回数' },
  'usage.credit': { en: 'Credit', 'zh-CN': 'Credit', 'zh-TW': 'Credit', ja: 'Credit' },
  'usage.timeRange': { en: 'Time range', 'zh-CN': '时间范围', 'zh-TW': '時間範圍', ja: '時間範囲' },
  'usage.type': { en: 'Type', 'zh-CN': '类型', 'zh-TW': '類型', ja: '種類' },
  ...
  'status.loading': { en: 'Loading...', 'zh-CN': '加载中...', 'zh-TW': '載入中...', ja: '読み込み中...' },
