const translations: Record<string, Record<string, string>> = {
  ...
  'chat.hideCronSessions': { en: 'Hide cron and CLI conversations', 'zh-CN': '隐藏定时任务和 CLI 对话', 'zh-TW': '隱藏定時任務和 CLI 對話', ja: 'cron・CLI会話を非表示' },
  'chat.showCronSessions': { en: 'Show cron and CLI conversations', 'zh-CN': '显示定时任务和 CLI 对话', 'zh-TW': '顯示定時任務和 CLI 對話', ja: 'cron・CLI会話を表示' },
