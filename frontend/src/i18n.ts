...
'settings.restartingUpdate': { en: 'Restarting…', 'zh-CN': '正在重启…', 'zh-TW': '正在重啟…', ja: '再起動中…' },
  ...
  'usage.waitingRefresh': { en: 'Waiting for refresh', 'zh-CN': '等待刷新', 'zh-TW': '等待重新整理', ja: '更新待ち' },
  ...
  'usage.noData': { en: 'No usage data', 'zh-CN': '暂无用量数据', 'zh-TW': '暫無用量資料', ja: '利用状況データなし' },
  'usage.noWindowData': { en: 'No window or model data', 'zh-CN': '暂无窗口或模型数据', 'zh-TW': '暫無視窗或模型資料', ja: '期間またはモデルデータなし' },
